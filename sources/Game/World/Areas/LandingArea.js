...
export class LandingArea extends Area
{
    constructor(model)
    {
        ...
        // Skip letters since we removed the title
        // this.setLetters()   // ← commented out
    ...
    setControls()
    {
        ...
        menuInstance.events.on('close', () => interactivePoint.show())
